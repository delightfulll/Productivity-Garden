...
function Addictions() {
    ...
    const [checkIns, setCheckIns] = useState<{ date: Date; stayedClean: boolean }[]>([]);
                ...
                <div className="content-container">
                    ...
                    <div className="history-container">
                        ...
                        <div className="history-list">
                            {checkIns.slice(-7).reverse().map((check, index) => (
                                <motion.div
                                    key={index}
                                    className={`history-item ${check.stayedClean ? 'clean' : 'slipped'}`}
                                ...
                                >
                                    ...
                                    <span>{check.stayedClean ? 'Stayed Clean' : 'Slipped Up'}</span>
                                </motion.div>
                            ))}
                        </div>
                    </div>
