...
function Journal() {
    ...
    const [entries, setEntries] = useState([
        {
            id: 1,
            content: "Today was a productive day. I completed all my tasks and felt great about my progress.",
            date: "2024-03-20",
        },
        {
            id: 2,
            content: " was a productive day. I completed all my tasks and felt great about my progress.",
            date: "2024-03-20",
        },
    ])
                            ...
                            {entries.map((entry, index) => (
                                ...
                                >
                                    <div className="flex flex-col">
                                        <span className="win-card-text">{entry.content}</span>
